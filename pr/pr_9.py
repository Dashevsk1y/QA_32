class Human:
    # Змінна для відстеження кількості створених об'єктів
    total_instances = 0
    ...
    def __init__(self):
        ...
        self.country = ""
        self.home_address = ""
        # Збільшуємо кількість створених об'єктів при кожному створенні нового об'єкта
        Human.total_instances += 1
...
# Вивести загальну кількість створених об'єктів
print(f"Загальна кількість створених об'єктів Human: {Human.get_total_instances()}")
